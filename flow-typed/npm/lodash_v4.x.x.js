...
declare module 'lodash/once' {
  declare module.exports: (func: Function) => Function;
}

declare module 'lodash/includes' {
  declare module.exports:
    & (<T>(array: ?Array<T>, value: T, fromIndex?: number) => bool)
    & (<T: Object>(object: T, value: any, fromIndex?: number) => bool)
    & ((str: string, value: string, fromIndex?: number) => bool);
}
