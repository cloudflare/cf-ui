...
import ButtonExample from '../packages/cf-component-button/example/basic/component';
import highlightedButtonExample from '!highlight-loader?raw=true&lang=jsx!../packages/cf-component-button/example/basic/component';
...
const Main = () =>
  <div>
    <p>
      ...
      while using "real-world" non-relative paths. <strong>Everything is hot
      reloaded.</strong> Code example is using a webpack loader (hot reloaded as well).
